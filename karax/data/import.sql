...
insert into games (id, name, setting, edition, ruleset, stylesheet) values (1, 'Eclipse Phase', 'Firewall', '1', 'ECLIPSE_PHASE_1.0', 'eclipse_phase_v1');
...
-- (27, null, localtimestamp, 'FREEBIE', 10, 'TRAIT', 'RIGHT_AT_HOME', null, 'FURY', null, 2),
